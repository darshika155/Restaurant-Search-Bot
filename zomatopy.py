...
class Zomato:
    ...
    def restaurant_search_new(self, query="", latitude="", longitude="", cuisines="", limit=5):
        """
    ...
    def check_city_ID(self, city_name):
        """
        Takes City Name as input.
        Returns the ID for the city given as input.
        """
        ...
        if len(a['location_suggestions']) == 0:
            ...
            return (a['location_suggestions'][0]["id"], a['location_suggestions'][0]["name"])
